...
async function scrapePrice(url) {
  try {
      ...
      $('div[name="list"] article').each((i, el) => {
        ...
        // const price = $(el).find('.relative .flex .flex .flex .text-right .flex .flex .flex .text-2xl').text();
...
async function main() {
  // scrapePrice("https://pricempire.com/cs2-items/skin/ak-47-case-hardened/factory-new");
  scrapePrice("https://pricempire.com/cs2-items/skin/ak-47-first-class");
}
